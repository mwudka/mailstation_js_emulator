...
function z80_do_opcodes()
{
  ...
  while(tstates < tstates_per_frame ) {
    ...
    ///  ****************** WARNING!!!!!!! ********************************
    ///  ***** It is a real bad idea to output anything in this loop, *****
    ///  ***** unless the tstate limit is real low!!!!!!!!!!!!!!!!!!  *****
    ///debuglog('pc: ' + z80.pc.toString(16));
    
    // Stop if we hit a breakpoint
    if (atbreakpoint()) break;
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    case 0xcd:		
      ...
      {  var calltempl, calltemph;   
         calltempl=readbyte_internal(z80.pc++);  z80.pc &= 0xffff;  tstates += ( 1 );;  
         calltemph=readbyte_internal(z80.pc++);  z80.pc &= 0xffff;  
         
      {  z80.sp--; z80.sp &= 0xffff; tstates += ( 3 );;  
         writebyte_internal(z80.sp,(z80.pc) >> 8);  
         
         z80.sp--; z80.sp &= 0xffff; tstates += ( 3 );;  
         writebyte_internal(z80.sp,(z80.pc) & 0xff);};  
         
         var pcl=calltempl; var pch=calltemph;  z80.pc = pcl | (pch << 8);};
...
//debugflag = false;   
    ...
    ///////////////// break out of while-loop here for single step.
    if (onestep) break;
